...
`{rmonocypher}` provides an easy-to-use tool for encrypting/decrypting data with R.
...
This package is backed by the cryptographic primitives provided by the [`monocypher`](https://monocypher.org/) library.

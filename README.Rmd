...
* The nonce used within 'monocypher' is 24-bytes and is large enough that 
  counter/ratcheting mechanisms do not need to be used to uniqueness - 24 random
  bytes (192 bits) of randomness is sufficient that nonce reuse is not an issue.
